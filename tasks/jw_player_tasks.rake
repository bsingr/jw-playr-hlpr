namespace :jw_player do
  ...
  task :install do
    ...
    puts 'installing swfobject.js to ' << RAILS_ROOT << '/public/javascripts'
  ...
  task :remove do
    ...
    puts 'removing swfobject.js'
    FileUtils.rm %{swfobject.js}.collect { |f| RAILS_ROOT + "/public/javascripts/" + f  }
  end
